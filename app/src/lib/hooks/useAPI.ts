...
export default function useAPI(endpoint: "/messages/[uid]", uid: string): Promise<Result<APIEndpoints["/messages/[uid]"]>>;
...
export default function useAPI<T extends keyof APIEndpoints>(endpoint: T): Promise<Result<APIEndpoints[T]>>;

export default function useAPI<T extends keyof APIEndpoints>(endpoint: T, uid?: string, body?: FormData) {
